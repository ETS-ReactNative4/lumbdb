...
var BaseStyledNativeComponent = function (_PureComponent) {
  inherits(BaseStyledNativeComponent, _PureComponent);
  ...
  function BaseStyledNativeComponent() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _PureComponent.call.apply(_PureComponent, [this].concat(args))), _this), _this.attrs = {}, _temp), possibleConstructorReturn(_this, _ret);
  }
...
var _StyledNativeComponent = (function (InlineStyle) {
  var createStyledNativeComponent = function createStyledNativeComponent(target, options, rules) {
    ...
    var StyledNativeComponent = React.forwardRef(function (props, ref) {
